package schedulednotificationjob.schema;
...
public class IncomingNotificationEventDeserializationSchema implements DeserializationSchema<IncomingNotificationEvent> {
  @Serial
